  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-black tracking-tight text-zinc-900  flex items-center gap-2.5">
            ...
            <span className="text-xs px-2.5 py-0.5 rounded-full bg-emerald-500/10 text-emerald-600  font-semibold flex items-center gap-1">
        ...
        <button
          onClick={loadData}
          className="self-start sm:self-auto flex items-center gap-2 px-3 py-2 text-xs font-semibold rounded-xl bg-zinc-100   hover:bg-slate-200 :bg-slate-700 text-zinc-700  transition-colors shadow-sm"
        >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {/* Card 1: Total Views */}
        <div className="p-5 rounded-2xl bg-white   border border-zinc-200/80   shadow-sm relative overflow-hidden group">
          <div className="absolute right-3 top-3 w-10 h-10 rounded-xl bg-zinc-100  flex items-center justify-center text-zinc-900  ">
            <Eye className="w-5 h-5" />
          </div>
          <p className="text-xs font-semibold text-zinc-500 ">Tổng lượt xem</p>
          <h3 className="text-2xl sm:text-3xl font-black text-zinc-900  mt-1.5">
        ...
        <div className="p-5 rounded-2xl bg-white   border border-zinc-200/80   shadow-sm relative overflow-hidden group">
          <div className="absolute right-3 top-3 w-10 h-10 rounded-xl bg-indigo-500/10 flex items-center justify-center text-indigo-600 ">
            <Users className="w-5 h-5" />
          </div>
          <p className="text-xs font-semibold text-zinc-500 ">Độc giả thực tế (Unique)</p>
          <h3 className="text-2xl sm:text-3xl font-black text-zinc-900  mt-1.5">
        ...
        <div className="p-5 rounded-2xl bg-white   border border-zinc-200/80   shadow-sm relative overflow-hidden group">
          <div className="absolute right-3 top-3 w-10 h-10 rounded-xl bg-emerald-500/10 flex items-center justify-center text-emerald-600 ">
            <Clock className="w-5 h-5" />
          </div>
          <p className="text-xs font-semibold text-zinc-500 ">Thời gian đọc TB</p>
          <h3 className="text-2xl sm:text-3xl font-black text-zinc-900  mt-1.5">
        ...
        <div className="p-5 rounded-2xl bg-white   border border-zinc-200/80   shadow-sm relative overflow-hidden group">
          <div className="absolute right-3 top-3 w-10 h-10 rounded-xl bg-rose-500/10 flex items-center justify-center text-rose-600 ">
            <BookOpen className="w-5 h-5" />
          </div>
          <p className="text-xs font-semibold text-zinc-500 ">Kho truyện / Chương</p>
          <h3 className="text-2xl sm:text-3xl font-black text-zinc-900  mt-1.5">
            {stats ? `${stats.activeStoriesCount} truyện` : "..."}
          </h3>
          <div className="flex items-center gap-2 text-xs text-zinc-500  font-medium mt-2">
            <span className="text-emerald-600 font-semibold">{stats?.activeStoriesCount} đang hiện</span>
            <span>•</span>
            <span className="text-zinc-900 font-semibold">{stats?.inactiveStoriesCount} tạm ẩn</span>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
          <div>
            <h3 className="font-bold text-lg text-zinc-900  flex items-center gap-2">
              ...
              {hoveredPoint && (
                <span className="text-xs font-normal text-zinc-900   bg-zinc-100  px-2 py-0.5 rounded-full">
          ...
          <div className="flex items-center p-1 rounded-xl bg-zinc-100   self-start sm:self-auto">
            <button
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="w-full bg-zinc-100   h-1.5 rounded-full overflow-hidden mt-2">
                        <div
                          className="bg-zinc-900  text-white  h-full rounded-full transition-all duration-500"
                          style={{ width: `${percent}%` }}
                        />
                      </div>
                    </div>
        ...
        <div className="p-5 sm:p-6 rounded-2xl bg-white   border border-zinc-200/80   shadow-sm flex flex-col">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h3 className="font-bold text-base text-zinc-900  flex items-center gap-2">
          ...
          <div className="flex-1 overflow-y-auto space-y-2.5 max-h-[380px] pr-1">
            {liveLogs.length === 0 ? (
              <p className="text-center text-xs text-zinc-400 py-12">Chưa có nhật ký đọc nào</p>
            ) : (
              liveLogs.map((log) => {
                ...
                return (
                  <div
                    key={log.id}
                    className="p-2.5 rounded-xl bg-zinc-50   border border-zinc-200   flex items-center justify-between gap-3 text-xs"
                  >
                    <div className="flex items-center gap-2.5 min-w-0">
                      <div className="w-7 h-7 rounded-lg bg-zinc-100  flex items-center justify-center text-zinc-900   flex-shrink-0">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-zinc-500  text-[11px] truncate">
                          Đã đọc: <span className="text-zinc-900   font-medium">{log.chapterTitle}</span>
                        </p>
                      </div>
                    </div>
